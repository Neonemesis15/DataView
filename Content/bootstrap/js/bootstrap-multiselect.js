...
!function($) {"use strict";// jshint ;_;
    ...
    function Multiselect(select, options) {
        ...
        this.$container = $(this.options.buttonContainer).append('<button type="button" class="multiselect dropdown-toggle ' + this.options.buttonClass + '" data-toggle="dropdown">' + this.options.buttonText(this.getSelected(), this.$select) + '</button>')
            .append('<ul class="multiselect-container multiselect_her dropdown-menu' + (this.options.dropRight ? ' pull-right' : '') + '"></ul>');
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length == 0) {
                    return this.nonSelectedText + ' <i class="icon-filter icon-white"></i>'; //'<b class="caret"></b>'; // modi js
                    console.log(v_icons);
                }
                else
                if (options.length > 3) {
                    return options.length + ' ' + this.nSelectedText + ' <i class="icon-filter icon-white"></i>'; //' <b class="caret"></b>'; // modi js
                    console.log(v_icons);
                }
                else {
                    var selected = '';
                    ...
                    return selected.substr(0, selected.length - 2) + ' <i class="icon-filter icon-white"></i>'; //' <b class="caret"></b>'; // modi js
                    console.log(v_icons);
                }
                /*
                if (options.length > 0) { //modi js
                    return options.length + ' ' + this.nSelectedText + ' <i class="icon-filter icon-white" style="border:solid 1px white;"></i>';
                }*/
        ...
        updateButtonText: function() {
           ...
           // $('button', this.$container).html(this.options.buttonText(options, this.$select)); // modificado por js
